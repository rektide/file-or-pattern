...
impl DoExecuteProcessor {
    pub fn new() -> Self { Self { expect_execution: false } }
...
impl Processor for DoExecuteProcessor {
    ...
    fn name(&self) -> &str { "DoExecuteProcessor" }
}
...
mod tests {
    ...
    fn test_expect_execution_non_executable() {
        ...
        assert_eq!(results[0].err.as_ref().unwrap().processor, "DoExecuteProcessor");
    }
